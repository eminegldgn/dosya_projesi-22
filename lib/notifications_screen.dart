...
// =========================================================
  ...
  Future<void> _loadNotifications() async {
    ...
    try {
      ...
      // Giriş yapılmamışsa veya bildirim verisi alınamamışsa
      // bunu sunucu hatası gibi göstermiyoruz.
      ...
      // Beklenmeyen bir hata olsa bile
      // kullanıcıya boş bildirim ekranı gösteriyoruz.
      setState(() {
        _isLoading = false;
